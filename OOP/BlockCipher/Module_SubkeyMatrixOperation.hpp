...
#ifndef ALGORITHM_OALDRESPUZZLECRYPTIC_MODULE_SUBKEYMATRIXOPERATION_HPP
#define ALGORITHM_OALDRESPUZZLECRYPTIC_MODULE_SUBKEYMATRIXOPERATION_HPP
...
namespace TwilightDreamOfMagical::CustomSecurity
{
	...
	namespace SED::BlockCipher
	{
		...
		{
			class Module_SubkeyMatrixOperation
			{
			...
			public:
				...
				explicit Module_SubkeyMatrixOperation( CommonStateData& CommonStateDataObject )
					: StateDataPointer( std::addressof( CommonStateDataObject ) ),
					  MixTransformationUtilObject( CommonStateDataObject )
				{}

				~Module_SubkeyMatrixOperation() = default;
			...
			private:
				...
				Module_MixTransformationUtil MixTransformationUtilObject;
...
#endif	//ALGORITHM_OALDRESPUZZLECRYPTIC_MODULE_SUBKEYMATRIXOPERATION_HPP
