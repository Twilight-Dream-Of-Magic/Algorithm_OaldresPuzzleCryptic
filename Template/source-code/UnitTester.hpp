	...
	*/
	...
	inline void Tester_BlockCryptograph_CustomOaldresPuzzleCryptic()
	{
		...
		*/
		...
		//Test Encryption
		Tester_OPC.plain_for_cipher_confusability(PlainData, Keys, 1024);
		Tester_OPC.key_for_cipher_diffusivity(PlainData, Keys, 1024);

		//Test Decryption
		Tester_OPC.cipher_for_plain_confusability(PlainData, Keys, 1024);
		Tester_OPC.key_for_plain_diffusivity(PlainData, Keys, 1024);
	}
}